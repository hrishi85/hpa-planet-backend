...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    profilePic: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    stageName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 32;
        minLength: 2;
...
export interface ApiHistoryHistory extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyHistory: Schema.Attribute.Blocks & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiInviteInvite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    inviteId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 17;
...
export interface ApiTrackTrack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    trackLink: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 256;
        minLength: 5;
